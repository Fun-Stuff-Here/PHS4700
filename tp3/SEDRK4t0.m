function qs=SEDRK4t0(problem, q0, t0, Deltat, g)
...
%   problem   : donnees du probleme
%   Deltat    : intervalle de temps
%   g         : membre de droite de ED. 
%               C'est un m-file de matlab
%               qui retourne la valeur de g au temps choisi

k1 = feval(g, problem, q0, t0);
k2 = feval(g, problem, q0+k1*Deltat/2, t0+Deltat/2);
k3 = feval(g, problem, q0+k2*Deltat/2, t0+Deltat/2);
k4 = feval(g, problem, q0+k3*Deltat, t0+Deltat);
